...
What matters is that if the models improve based on this metric, you also reach the goal that you want to achieve: predict tomorrows sunshine hours. 
As soon as you have the feeling that whatever you are using as a metric does not help you reach your goal, you should pick a different one!
::::
:::
